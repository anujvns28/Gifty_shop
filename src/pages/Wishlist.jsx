          ...
          <div className="w-full h-full flex flex-col gap-4">
            {wishlist.map((product) => {
              return (
                <div
                  key={product._id}
                  className="w-full p-2 border border-black flex gap-1 lg:gap-5 "
                >
                  <div className="w-full p-2  flex flex-row lg:gap-5 gap-2 ">
                    <Link to={`/shouse/${product._id}`}>
                      <div className="lg:w-[150px] lg:h-[150px] w-[120px] h-[120px] object-fill">
                        <img
                          className="w-full h-full rounded-md border border-solid"
                          src={product.mainImage}
                        />
                      </div>
                    </Link>
                    <div>
                      <p className="lg:text-2xl  lg:font-semibold font-bold">
                        {product.productName}
                      </p>
                  ...
                  <p
                    ...
                    className="text-2xl h-fit font-semibold items-center w-fit cursor-pointer"
                  >
                    <MdDelete />
                  </p>
                </div>
